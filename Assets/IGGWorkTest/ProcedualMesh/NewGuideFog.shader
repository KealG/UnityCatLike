Shader "Unlit/CityFog"
{
    Properties
    {
        ...
        _Mask1("MaskTexture", 2D) = "white" {}
        _Mask2("MaskTexture", 2D) = "white" {}
        ...
        _MoveDir2("MoveDir2", Vector) = (1, 1, 1, 1)
        _MoveDir1("MoveDir1", Vector) = (1, 1, 1, 1)
        _FogMoveSpeed("FogMoveSpeed", Vector) = (1, 1, 1, 1)
        ...
        SubShader
        {
            ...
            Pass
            {
                ...
                v2f vert(appdata v)
                {
                    ...
                    float4 dir2 = frac(_Time.y * _MoveDir * _Speed.zzww);
                    float3 worldPos = mul((float3x3)unity_ObjectToWorld, v.vertex);
                    float4 tex1 = worldPos.xzxz + dir1;
                    float4 tex2 = worldPos.xzxz + dir2;
